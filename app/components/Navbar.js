          ...
          <><button onClick={() => setshowdropdown(!showdropdown)}  setTime onBlur={()=>{
            ...
            <div id="dropdownInformation" className={`z-10 ${showdropdown ? "" : "hidden"} absolute bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700 dark:divide-gray-600`}>
              ...
              <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownInformationButton">
                ...
                <li>
                <li>
                  <Link href={`/${session?.user?.name || "username"}`} className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Profile</Link>
                </li>
